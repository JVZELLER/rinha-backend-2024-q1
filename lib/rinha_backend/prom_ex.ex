defmodule RinhaBackend.PromEx do
  @moduledoc """
  ...
  use PromEx, otp_app: :rinha_backend
  ...
  def plugins do
    [
      ...
      Plugins.Application,
      Plugins.Beam,
      # {Plugins.Phoenix, router: RinhaBackendWeb.Router, endpoint: RinhaBackendWeb.Endpoint},
      Plugins.Ecto,
      {Plugins.PlugRouter,
       event_prefix: [:rinha_backend, :bandit, :endpoint], routers: [RinhaBackendWeb.Endpoint]},
      RinhaBackend.PromExDomainMetrics
      # Plugins.Oban,
      ...
      # RinhaBackend.Users.PromExPlugin
    ]
  end
  ...
  def dashboards do
    [
      ...
      # {:rinha_backend, "/grafana_dashboards/user_metrics.json"}
    ]
  end
end
